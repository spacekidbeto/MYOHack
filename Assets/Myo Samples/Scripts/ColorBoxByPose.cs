...
public class ColorBoxByPose : MonoBehaviour
{
	...
	public AudioClip Instrument4;
	public AudioClip Instrument5;
	public AudioClip Instrument6;
	public AudioClip Instrument7;
	public AudioClip Instrument8;
	public AudioClip Instrument1b;
	public AudioClip Instrument2b;
	public AudioClip Instrument3b;
	public AudioClip Instrument4b;
	public AudioClip Instrument5b;
	public AudioClip Instrument6b;
	...
	void Update ()
	{
		...
		if (thalmicMyo.pose != _lastPose) {
			...
			if (thalmicMyo.pose == Pose.Fist) {
				...
				//if(note[y]==1){
				//				if(Sounds1[noteselect].GetComponent<AudioSource>().isPlaying){
				...
				//					}
				//					Sounds2[y].GetComponent<AudioSource>().pitch=Mathf.Pow (2f,(OctaveOffset+TransposeOffset)/12f);
